...
public class AlbumDisplayPageFriendlyURLResolver implements FriendlyURLResolver {

	private final static Logger LOG = LoggerFactory.getLogger(AlbumDisplayPageFriendlyURLResolver.class);
