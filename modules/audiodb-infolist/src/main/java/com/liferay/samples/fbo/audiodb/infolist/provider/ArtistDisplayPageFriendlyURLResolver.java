...
public class ArtistDisplayPageFriendlyURLResolver implements FriendlyURLResolver {

	private final static Logger LOG = LoggerFactory.getLogger(ArtistDisplayPageFriendlyURLResolver.class);
